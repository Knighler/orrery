...
gltfLoaderEros.load(new URL('../public/eros.glb', import.meta.url).href, (gltf) => {
...
gltfLoaderBennu.load(new URL('../public/bennu.glb', import.meta.url).href, (gltf) => {
...
gltfLoaderItokawa.load(new URL('../public/ItokawaReal.glb', import.meta.url).href, (gltf) => {
...
ItokawaGroup.scale.set(1/4020231,1/4020231,1/4020231);
...
function animate() {
  ...
  const timeIncrement = (deltaTime * speedFactor*100) / 86400;
  ...
  ErosGroup.rotation.y += 0.00125383 * speedFactor;
  BennuGroup.rotation.y+=0.000406198 * speedFactor;
  ItokawaGroup.rotation.y+=0.0001438*speedFactor
